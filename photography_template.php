...
<link href="<?php bloginfo(template_directory) ?>/screen_photography.css" rel="stylesheet" media="screen">
...
if(is_page('FASHION')){
	$cat_name= "photography_fashion"; 
}
if(is_page('MUSIC')){
	$cat_name= "photography_music"; 
}
if(is_page('OTHER')){
	$cat_name= "photography_other"; 
}
...
foreach($recents as $recent) {
	...
	preg_match_all('/<img[^>]+>/i',$recent->content,$result); 
